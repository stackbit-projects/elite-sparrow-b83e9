    ...
    render() {
        return (
            <footer id="colophon" className="site-footer">
              ...
              <a href="#top" style={{position:'fixed', right:'20px', bottom:'20px', border: '2px solid white', borderRadius:'100px', padding:'4px 14px 8px 14px',background:'#171717',textDecoration:'none',fontSize:'18px',color:'white'}}>▲</a>
            </footer>
        );
    }
}
